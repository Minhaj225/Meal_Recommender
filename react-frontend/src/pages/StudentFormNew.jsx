        ...
        <div className="card bg-base-100 shadow-xl">
          <div className="card-body">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="form-control">
                <label className="label">
                  <span className="label-text font-semibold">Cuisine Preferences</span>
                </label>
              ...
              <div className="form-control">
                <label className="label">
                  <span className="label-text font-semibold">Dietary Preference</span>
                </label>
              ...
              <div className="form-control">
                <label className="label">
                  <span className="label-text font-semibold">Preferred Meal Types</span>
                </label>
              ...
              <div className="form-control">
                <label className="label">
                  <span className="label-text font-semibold">Activity Level</span>
                </label>
                <select
                  name="activityLevel"
              ...
              <div className="form-control">
                ...
                />
                <label className="label">
                  <span className="label-text-alt">Separate multiple allergies with commas</span>
                </label>
              </div>
